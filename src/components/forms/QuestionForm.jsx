...
const QuestionForm = ({open, onClose, userId}) => {
  ...
  return (
    <Dialog open={open} fullWidth maxWidth="sm" scroll="paper" onClose={closeModal} keepMounted={false}>
      ...
      <DialogContent>
        <form onSubmit={handleSubmit(onSubmit)} className="form">
          ...
          <DialogActions>
            <Button onClick={closeModal} color="error" disabled={isLoading}>cerrar</Button>
            <Button type="submit" color="success" disabled={isLoading}>Enviar</Button>
          </DialogActions>
        </form> 
      </DialogContent>
    </Dialog>
